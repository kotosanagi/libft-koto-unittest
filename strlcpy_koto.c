...
int main()
{
	...
	char src1[] = "shita";
	size_t i = 0;
	strlcpy(dst12, src1, i);
	ft_strlcpy(dst11, src1, i);
	result_tmp = (ft_strlcpy(dst11, src1, i) == strlcpy(dst12, src1, i) && (strcmp(dst11, dst12) == 0)) ? 1 : 0;
	printf("n:%2zu, len_dst:%2lu, ft_ret:%2lu, ori_ret:%2lu, dst11:%10s, dst12:%10s, src1:%10s, issame:%d\n",
	...
	printf("n:%2zu, len_dst:%2lu, ft_ret:%2lu, ori_ret:%2lu, dst21:%10s, dst22:%10s, src2:%10s, issame:%d\n",
	...
	printf("n:%2zu, len_dst:%2lu, ft_ret:%2lu, ori_ret:%2lu, dst31:%10s, dst32:%10s, src3:%10s, issame:%d\n",
	...
	printf("n:%2zu, len_dst:%2lu, ft_ret:%2lu, ori_ret:%2lu, dst41:%10s, dst42:%10s, src4:%10s, issame:%d\n",
	...
	printf("n:%2zu, len_dst:%2lu, ft_ret:%2lu, ori_ret:%2lu, dst51:%10s, dst52:%10s, src5:%10s, issame:%d\n",
	...
	printf("n:%2zu, len_dst:%2lu, ft_ret:%2lu, ori_ret:%2lu, dst61:%10s, dst62:%10s, src6:%10s, issame:%d\n",
	...
	printf("n:%2zu, len_dst:%2lu, ft_ret:%2lu, ori_ret:%2lu, dst71:%10s, dst72:%10s, src7:%10s, issame:%d\n",
	...
	printf("n:%2zu, len_dst:%2lu, ft_ret:%2lu, ori_ret:%2lu, dst81:%10s, dst82:%10s, src8:%10s, issame:%d\n",
	...
	printf("n:%2zu, len_dst:%2lu, ft_ret:%2lu, ori_ret:%2lu, dst91:%10s, dst92:%10s, src9:%10s, issame:%d\n",
